        ...
        <div className="flex flex-col-reverse lg:flex-row items-center lg:items-start">
          ...
          >
            ...
            <p className="text-lg text-white/80 mb-8 font-light max-w-xl">
              NextWave helps education agents connect international students
              with premier UAE universities. Maximize your commissions while
            ...
            <div className="mt-16 flex items-center">
              <div className="flex -space-x-2">
                ...
                <div className="w-10 h-10 rounded-full bg-yellow-500 flex items-center justify-center text-white text-xs font-medium border-2 border-black">
                  JK
                </div>
              </div>
              <div className="ml-4">
                <p className="text-white text-sm font-medium">
                  Trusted by many agents worldwide
                </p>
          ...
          <div
            className={`relative lg:w-1/2 flex justify-center items-center transition-all duration-1000 delay-300 ease-out transform ${isVisible ? "translate-y-0 opacity-100" : "translate-y-10 opacity-0"}`}
          >
            <div className="relative w-full max-w-md aspect-square">
              ...
              <div className="hidden absolute inset-0 bg-gradient-to-br from-black to-gray-900 rounded-full border border-gray-800 p-10 lg:flex items-center justify-center overflow-hidden">
                <div className="relative z-10 text-center">
                  <div className="text-5xl font-bold mb-2 bg-clip-text text-transparent bg-gradient-to-r from-white to-white/80">
                    20+
                  </div>
