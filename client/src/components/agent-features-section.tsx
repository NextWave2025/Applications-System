  ...
  const features = [
    {
      ...
      description:
        "Access 20+ licensed UAE universities in one dashboard with real-time updates on programs, tuition, and scholarships.",
    ...
    },
    {
      ...
      title: "Portal & CRM",
      description:
        "Track student applications, documents, and communication in one place with no need for external tools or complicated systems.",
    ...
    },
    {
      ...
      description:
        "Connect your students to our 2,000+ student community in UAE that helps them network and access internships and workshops.",
    ...
    >
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="max-w-3xl mx-auto mb-16 text-center">
          <div className="nextwave-badge-with-dot mb-6">Exclusive Benefits</div>
          ...
          <p className="text-lg md:text-xl font-light text-gray-600 max-w-3xl mx-auto mt-6">
            Join NextWave, the #1 platform for admission in UAE and enjoy these
            exclusive benefits designed to maximize your success
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
          {features.map((feature, index) => (
            ...
            >
              {/* Background gradient */}
              <div
                className={`absolute inset-0 bg-gradient-to-br ${feature.color} opacity-30 pointer-events-none`}
              ></div>
