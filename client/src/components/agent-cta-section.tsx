...
export default function AgentCTASection() {
  ...
  return (
    <section id="agent-cta-section" className="py-24 bg-black text-white relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className={`transition-all duration-1000 ease-out transform ${isVisible ? 'translate-x-0 opacity-100' : '-translate-x-10 opacity-0'}`}>
              ...
              <h2 className="heading-2 mb-6">
                Ready to <span className="text-primary">Grow</span> Your Education Agency?
              </h2>
              <div className="h-1 w-24 bg-primary mb-8 rounded-full"></div>
              <p className="subtitle text-white/80 mb-10 font-light">
                Join our network of successful agents and start placing students in top UAE universities today. With Guide, you gain instant access to our platform, marketing materials, and expert support.
              </p>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 mb-10">
                <div>
                  ...
                  <p className="text-white/70 text-sm font-light">Partner Universities</p>
                </div>
                <div>
                  <p className="text-4xl font-bold text-primary mb-1">913+</p>
                  <p className="text-white/70 text-sm font-light">Academic Programs</p>
                </div>
                <div>
                  <p className="text-4xl font-bold text-primary mb-1">100%</p>
                  <p className="text-white/70 text-sm font-light">Commission Rate</p>
                </div>
              </div>
            </div>
            ...
            <div className={`transition-all duration-1000 delay-300 ease-out transform ${isVisible ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
              <div className="bg-gray-900 rounded-2xl p-8 border border-gray-800 shadow-2xl relative">
                ...
                <h3 className="text-2xl font-bold mb-6">Join as an Agent Today</h3>
                <p className="text-white/70 mb-8 font-light">
                  Complete our agent registration form and get approved within 48 hours to start earning commissions.
                </p>
