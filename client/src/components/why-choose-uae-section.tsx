  ...
  const features = [
    {
      ...
      description:
        "UAE universities offer internationally recognized degrees and partnerships with leading global institutions, ensuring students receive premium education.",
      gradient:
    ...
    },
    {
      ...
      title: "Global Hub",
      description:
        "Strategic location connecting East and West, with a diverse multicultural environment and networking opportunities for international careers.",
      gradient:
    ...
    },
    {
      ...
      title: "Career Growth",
      description:
        "Access to thriving job markets in technology, finance, healthcare, and tourism with competitive salaries and rapid professional advancement.",
      gradient:
    ...
    },
    {
      ...
      description:
        "A safe environment with modern infrastructure, excellent healthcare, vibrant cultural experiences, and high standard of living for students.",
      gradient:
          ...
          {features.map((feature, index) => (
            ...
            >
              ...
              <div className="p-8 relative h-full flex flex-col">
                ...
                <div
                  className={`absolute inset-0 ${feature.gradient} opacity-60 pointer-events-none`}
                ></div>
